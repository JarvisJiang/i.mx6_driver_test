...
static const char qt_meta_stringdata_ledtest[] = {
    "ledtest\0\0LED1_Toggle()\0LED2_Toggle()\0"
};
...
void ledtest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->LED1_Toggle(); break;
        case 1: _t->LED2_Toggle(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData ledtest::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ledtest::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ledtest,
      qt_meta_data_ledtest, &staticMetaObjectExtraData }
};
